Pod::Spec.new do |s|
    ...
    s.authors      = { 'tinswin' => ''}
    s.homepage     = 'http://git.aishepin8.com/ios/framework-SMRbasecore'
    s.platform     = :ios
    s.ios.deployment_target = '9.0'
    s.requires_arc = true
    s.source       = { :git => 'git@git.aishepin8.com:ios/framework-SMRbasecore.git' }
    ...
    s.subspec 'SMRUIKit' do |ss|
        ...
        ss.dependency 'IQKeyboardManager', '~> 3.3.7'
